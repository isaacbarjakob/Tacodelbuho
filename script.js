...
form.addEventListener('submit', async (e)=>{
  ...
  try{
    ...
    if(response.ok){
      status.textContent='Tack! Din bokningsförfrågan är skickad. Vi återkommer med bekräftelse.';
      form.reset();
    }else{
      status.textContent='Något gick fel. Ring oss gärna på 08-410 441 02.';
    }
  }catch(error){
